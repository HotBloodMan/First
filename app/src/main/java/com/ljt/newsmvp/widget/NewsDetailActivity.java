...
import com.ljt.fastlivery.utils.ToolsUtil;
import com.ljt.newsmvp.presenter.NewsDetailPresenter;
import com.ljt.newsmvp.presenter.NewsDetailPresenterImpl;
...
public class NewsDetailActivity extends SwipeBackActivity implements NewsDetailView{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LoadImageUtils.display(getApplicationContext(), (ImageView) findViewById(R.id.ivImage),mNews.getImgsrc());
